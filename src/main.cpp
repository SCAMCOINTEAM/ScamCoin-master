...
int64 nChainStartTime = 1403008800;
...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, int nHeight)
{
    ...
    nRewardCoinYear = MAX_ScamCoin_PROOF_OF_STAKE;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in ScamCoin
    bool fStrictPayToScriptHash = true; // Always active in ScamCoin
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "For ScamCoin LAUNCH";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0x1c14e34dc590fc726a44e8cd228acb7e42481a9295074f3665cd91b838c23b9d"));
